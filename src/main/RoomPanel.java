...
public class RoomPanel extends JPanel implements ActionListener {
    ...
    public static final int ROOM_WIDTH_HALF = RoomPanel.W_WIDTH / 2;
    public static int W_HEIGHT = 674;
    public static final int ROOM_HEIGHT_HALF = RoomPanel.W_HEIGHT / 2;
    ...
    private void addAllImages() {
        vinylList.add(new Vinyl("'Still With You' by JK of BTS", "../assets/discs/stillWithYouDisc.png",
                "songs/stillMix.mp3", minim, ROOM_WIDTH_HALF, ROOM_HEIGHT_HALF, vinylList.size()));
        ...
        vinylList.add(new Vinyl("'Dope Lovers' by DPR IAN", "../assets/discs/dopeDisc.png", "songs/dopeLoversMix.mp3",
                minim, ROOM_WIDTH_HALF, ROOM_HEIGHT_HALF, vinylList.size()));
        ...
        vinylList.add(new Vinyl("'Fly Me to the Moon' by Frank Sinatra", "../assets/discs/flyDisc.png",
                "songs/moonMix.mp3", minim, ROOM_WIDTH_HALF, ROOM_HEIGHT_HALF, vinylList.size()));
        ...
        vinylList.add(new Vinyl("'Jasmine' by DPR LIVE", "../assets/discs/jasmineDisc.png", "songs/jasmineMix.mp3", minim,
                ROOM_WIDTH_HALF, ROOM_HEIGHT_HALF, vinylList.size()));
        ...
        vinylList.add(new Vinyl("'No Blueberries' by DPR IAN ft. CL, DPR LIVE", "../assets/discs/noBlueDisc.png",
                "songs/noBlueMix.mp3", minim, ROOM_WIDTH_HALF, ROOM_HEIGHT_HALF, vinylList.size()));
    ...
    private void addAllSleeves() {
        sleeveList.add(new Sleeve("../assets/sleeves/sleeveJK.jpg", "sounds/sleeveSlide.mp3", minim,
                "../assets/sleeves/takeOut1.png", ROOM_WIDTH_HALF, ROOM_HEIGHT_HALF, sleeveList.size()));

        sleeveList.add(new Sleeve("../assets/sleeves/sleeveMITOWhite.jpg", "sounds/sleeveSlide.mp3", minim,
                "../assets/sleeves/takeOut2.png", ROOM_WIDTH_HALF, ROOM_HEIGHT_HALF, sleeveList.size()));

        sleeveList.add(new Sleeve("../assets/sleeves/sleeveMoon.jpg", "sounds/sleeveSlide.mp3", minim,
                "../assets/sleeves/takeOut3.png", ROOM_WIDTH_HALF, ROOM_HEIGHT_HALF, sleeveList.size()));

        sleeveList.add(new Sleeve("../assets/sleeves/sleeveHer.jpg", "sounds/sleeveSlide.mp3", minim,
                "../assets/sleeves/takeOut4.png", ROOM_WIDTH_HALF, ROOM_HEIGHT_HALF, sleeveList.size()));

        sleeveList.add(new Sleeve("../assets/sleeves/sleeveRose.jpg", "sounds/sleeveSlide.mp3", minim,
                "../assets/sleeves/takeOut5.png", ROOM_WIDTH_HALF, ROOM_HEIGHT_HALF, vinylList.size()));

        sleeveList.add(new Sleeve("../assets/sleeves/sleeveMITOBlack.jpg", "sounds/sleeveSlide.mp3", minim,
                "../assets/sleeves/takeOut6.png", ROOM_WIDTH_HALF, ROOM_HEIGHT_HALF, sleeveList.size()));
    ...
    private void updateTime() {
        long previousSecond = currentTimeSec;
    ...
    public void paintComponent(Graphics g) {
        ...
        if (state > RECORD_CLOSE) {
            ...
            isVinylSet(g2, gVinyl, VINYL_SET);
            isVinylSet(g2, gVinyl, SONG_PLAYING);
    ...
    private void isVinylSet(Graphics2D g2, Graphics2D gVinyl, int vinylSet) {
        if (state == vinylSet) {
            sleeveList.get(selectedSongIndex).draw(g2);
            box.drawFront(g2);
            recPlyr.drawAttachments(g2);
        ...
        if (state >= RECORD_CLOSE) {
            ...
            if (state == SONG_PLAYING) {
                ...
                if (Candle.state != Candle.CANDLE_BURN) {
                    ...
                    if (!lighter.getOn()) {
                        status = "Adjust volume with knobs, pause song by clicking power button. Otherwise enjoy the song and candle!  |  Selected Song: " + selectedVinyl.getSongInfo();
                    }
                }
                ...
                // song ended
                if (songLengthPlayed >= (float) selectedVinyl.getSound().length() / 1000) {
                    songLengthPlayed = 0;
                    selectedVinyl.getSound().pause();
                    state = REPLAY;
                }
        ...
        public void mouseDragged(MouseEvent e) {
            ...
            if (discPicked) {
                ...
                if (!selectedVinyl.getInSleeve()) {
                    ...
                    if (selectedVinyl.getX() >= ROOM_WIDTH_HALF*1.5) {
